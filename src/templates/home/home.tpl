  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> {$fil}</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-aqua-active"  style="background: url('{$Users.group_cover}') center center;">
                <!-- <div class="caption-title"> -->
              <a href="index.php?gestion=users&action=details&id={$Users.user_id}"><h3 class="widget-user-username caption-title_user">{$Users.user_name} {$Users.user_firstname} - {$Users.group_name}</h3></a>
       <!--        </div> -->
              <h5 class="widget-user-desc"></h5>
            </div>
            <div class="widget-user-image">
              <img class="img-circle" style="background: #FFFFFF; border-color: lightgray" src="{$Users.user_profilPicture}" alt="User Avatar">
            </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user-2">
            <!-- Add the bg color to the header using any of the bg-* classes -->
            <div class="widget-user-header bg-yellow" style="background: url('{$Groups.group_cover}') center center;">
            <!-- <img class="img" src="upload_files/group_cover/{$Groups.group_cover}" alt="User Avatar"> -->
              <div class="widget-user-image">
              <img class="img-circle" src="{$Groups.group_avatar}" alt="User Avatar">
              </div>
              <!-- /.widget-user-image -->
              <a href="index.php?gestion=groups&action=details&id={$Groups.group_id}"><h3 class="widget-user-username caption-title-group">{$Groups.group_name}</h3>
             <a href="index.php?gestion=groups&action=details&id={$Groups.group_id}"><h5 class="widget-user-desc caption-title-activity">{$Groups.group_activity}</h5>
            </div>
