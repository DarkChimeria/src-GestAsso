<?php
/* Smarty version 3.1.29, created on 2017-02-22 21:52:06
  from "/var/www/html/p2/templates/users/details.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_58adf9f630f916_76507582',
  'file_dependency' => 
  array (
    '9da628a3edae1e30353bb90b7451adbbc093b449' => 
    array (
      0 => '/var/www/html/p2/templates/users/details.tpl',
      1 => 1487796724,
      2 => 'file',
    ),
  ),
...
function content_58adf9f630f916_76507582 ($_smarty_tpl) {
  			...
  			<div class="col-md-3">
  				...
  				<div class="box box-primary">
  					<div class="box-body box-profile">
  						<img class="profile-user-img img-responsive img-circle" src="<?php echo $_smarty_tpl->tpl_vars['user_profilPicture']->value;?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['user_firstname']->value;?>
  						...
  						<ul class="list-group list-group-unbordered">
  							<li class="list-group-item">
  								<b>Inscrit le</b> <a class="pull-right"><?php echo utf8_encode(smarty_modifier_date_format($_smarty_tpl->tpl_vars['user_dateCreation']->value,"%d %B %Y"));?>
</a>
  							</li>
  							<li class="list-group-item">
...
?>
             ...
             <li>
              ...
              <div class="timeline-item">
               ...
               <h3 class="timeline-header"><a href="index.php?gestion=groups&action=details&id=<?php echo $_smarty_tpl->tpl_vars['History']->value['group_id'];?>
...
">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="<?php echo $_smarty_tpl->tpl_vars['user_profilPicture']->value;?>
" width="25%"/>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   <input type="number" class="form-control" id="inputName" placeholder="Name" name="usertype_id" min="1" max="3" value="<?php echo $_smarty_tpl->tpl_vars['usertype_id']->value;?>
">
                 </div>
               </div>
               <div class="form-group">
