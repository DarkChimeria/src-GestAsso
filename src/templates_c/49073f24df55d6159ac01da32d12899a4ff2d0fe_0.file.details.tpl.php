<?php
/* Smarty version 3.1.29, created on 2017-02-20 12:47:26
  from "/var/www/html/p2/templates/groups/details.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_58aad74ee403a8_18929232',
  'file_dependency' => 
  array (
    '49073f24df55d6159ac01da32d12899a4ff2d0fe' => 
    array (
      0 => '/var/www/html/p2/templates/groups/details.tpl',
      1 => 1487591207,
      2 => 'file',
    ),
  ),
...
function content_58aad74ee403a8_18929232 ($_smarty_tpl) {
  			...
  			<div class="col-md-3">
  				...
  				<div class="box box-primary">
  					<div class="box-body box-profile">
  						<img class="profile-user-img img-responsive img-circle" src="<?php echo $_smarty_tpl->tpl_vars['group_avatar']->value;?>
...
?>
                  ...
                  <div class="col-md-4 col-sm-6 col-xs-12">
                   <div class="info-box"><span class="info-box-icon" style="background-color: rgb(<?php echo $_smarty_tpl->tpl_vars['Actifs']->value['couleurBG'];?>
                     ...
                     <a href="index.php?gestion=users&action=details&id=<?php echo $_smarty_tpl->tpl_vars['Actifs']->value['user_id'];?>
"><img class="user-actifs" height="90" width="90" src="<?php echo $_smarty_tpl->tpl_vars['Actifs']->value['user_avatar'];?>
"></span></a>
                     ...
                     <div class="info-box-content">
                       ...
                       <span class="info-box-number"><?php echo $_smarty_tpl->tpl_vars['Actifs']->value['user_birth'];?>
                  ...
                  <div class="tab-pane" id="add">
                   ...
                   <div class="post">
                    <div class="content">
                     <div class="row">
                      <?php
$_from = $_smarty_tpl->tpl_vars['notin']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
$__foreach_NotIn_2_saved_item = isset($_smarty_tpl->tpl_vars['NotIn']) ? $_smarty_tpl->tpl_vars['NotIn'] : false;
$_smarty_tpl->tpl_vars['NotIn'] = new Smarty_Variable();
$_smarty_tpl->tpl_vars['NotIn']->_loop = false;
foreach ($_from as $_smarty_tpl->tpl_vars['NotIn']->value) {
$_smarty_tpl->tpl_vars['NotIn']->_loop = true;
$__foreach_NotIn_2_saved_local_item = $_smarty_tpl->tpl_vars['NotIn'];
?>


                      <div class="col-md-4 col-sm-6 col-xs-12">
                       <div class="info-box"><span class="info-box-icon" style="background-color: rgb(<?php echo $_smarty_tpl->tpl_vars['NotIn']->value['couleurBG'];?>
)">
                         <a href="index.php?gestion=users&action=details&id=<?php echo $_smarty_tpl->tpl_vars['NotIn']->value['user_id'];?>
"><img class="user-actifs" height="90" width="90" src="<?php echo $_smarty_tpl->tpl_vars['NotIn']->value['user_avatar'];?>
"></span></a>
                         <!-- <span class="info-box-icon bg-aqua"><i class="ion ion-ios-gear-outline"></i></span> -->

                         <div class="info-box-content">
                          <span class="info-box-text"><?php echo $_smarty_tpl->tpl_vars['NotIn']->value['user_pseudo'];?>
</span>
                          <span class="info-box-number"><?php echo $_smarty_tpl->tpl_vars['NotIn']->value['user_birth'];?>
<small> ans</small></span>
                          <a href="#"> <span class="label label-danger">Retirer le membre du groupe</span></a>
                        </div>
                        <!-- /.info-box-content -->
                    ...
                    <?php
$_smarty_tpl->tpl_vars['NotIn'] = $__foreach_NotIn_2_saved_local_item;
}
if ($__foreach_NotIn_2_saved_item) {
$_smarty_tpl->tpl_vars['NotIn'] = $__foreach_NotIn_2_saved_item;
}
?>
                  </div>
                </div>
            ...
            <div class="tab-pane" id="settings">
              <form class="form-horizontal" method="POST" enctype="multipart/form-data">
               <div class="form-group">
                ...
                <div class="col-sm-10">
                 <input type="text" class="form-control" id="group_name" name="group_name" value="<?php echo $_smarty_tpl->tpl_vars['group_name']->value;?>
">
               </div>
             </div>
             <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" id="group_description" name="group_description" placeholder="Experience" value=""><?php echo $_smarty_tpl->tpl_vars['group_description']->value;?>
</textarea>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-10">
               <input type="text" class="form-control" id="group_activity" name="group_activity" placeholder="Name" value="<?php echo $_smarty_tpl->tpl_vars['group_activity']->value;?>
">
             </div>
           </div>
           <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <img src="<?php echo $_smarty_tpl->tpl_vars['group_avatar']->value;?>
" width="10%"/>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <img src="<?php echo $_smarty_tpl->tpl_vars['group_cover']->value;?>
" width="30%"/>
            </div>
          </div>
